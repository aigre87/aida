...
gulp.task('libs:build', function() {
    gulp.src([ // Берем все необходимые библиотеки
        ...
        'src/libs/jquery-hammerjs/jquery.hammer.js',
...
gulp.task('styles:build', function () {
    ...
    gulp.src([path.src.styles, 'src/styles/other/symbol/src/styles/*.+(sass|scss|css)'])               // Выберем наш .sass|scss
        .pipe(plumber())
